 	...
 	$.fn.lfm = function(options){
		...
		function isLoaded (albumElement) {
			...
			for (var i = 0; i < albums.length; i++){
				var markup = $("<div class='album'><div class='front'><div class='shadow'></div><img src='" + albums[i].art + "'><div class='alpha'></div></div><div class='back'><h2 class='artist-name'>" + albums[i].artist + "</h2><h1 class='album-name'>" + albums[i].name + "</h1><h3>" + albums[i].played + " tracks played</h3></div></div>");
